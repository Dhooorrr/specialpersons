...
function katateksnimasi(){
      ...
      strings: ["" + initeksnimasi], startDelay: 300, speed: 100, lifeLike: true,cursor: true,
      afterComplete: function(){
      	teksnimasi.innerHTML = initeksnimasi;
          setTimeout(smn,200);
      },
      onStringTyped: function() {
        const ketikSound = document.getElementById("ketikSound");
        ketikSound.currentTime = 0; // Reset waktu audio
        ketikSound.play(); // Mainkan suara
    }
    }).go();
}
